...
global.authFile = `raisa.json`
//`${opts._[0] || 'session'}.data.json`
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6281310253704-1616818532@g.us`, {text: 'Server Started!' }) //made by Muhammad Ridwan Reynaldy 
}
...
let isInit = true, handler = require('./raisa')
global.reloadHandler = function (restatConn) {
  let Handler = require('./raisa')
  ...
  conn.bye = 'Nice @user beban already gone!'
  conn.spromote = 'Berhasil menaikkan jabatan @user menjadi pejabat di grub @subject !'
  conn.sdemote = 'Berhasil menurunkan @user menjadi rakyat biasa di grub @subject !'
