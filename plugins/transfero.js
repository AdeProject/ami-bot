                ...
                //if (global.db.data.users[m.sender].money >= count * 1) {
                 //   try {
                    //    global.db.data.users[m.sender].money -= count * 1
                        ...
                        conn.reply(who, `Selamat kamu mendapatkan tambahan uang sebesar ${count}\nFrom: *Owner*`.trim(), m)
                  /*  } catch (e) {
                   //     global.db.data.users[m.sender].money += count * 1
             ...
             case 'exp':
              //  if (global.db.data.users[m.sender].exp >= count * 1) {
                    ...
                    //    global.db.data.users[m.sender].exp -= count * 1
                        ...
                        conn.reply(who, `Selamat kamu mendapatkan tambahan exp sebesar ${count}\nFrom: *Owner*`.trim(), m)
                  /*  } catch (e) {
                        global.db.data.users[m.sender].exp += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                //if (global.db.data.users[m.sender].limit >= count * 1) {
                  //  try {
                     //   global.db.data.users[m.sender].limit -= count * 1
                        ...
                        conn.reply(who, `Selamat kamu mendapatkan tambahan limit sebesar ${count}\nFrom: *Owner*`.trim(), m)
                   /* } catch (e) {
                        global.db.data.users[m.sender].limit += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
