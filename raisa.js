...
module.exports = {
    ...
    async participantsUpdate({ id, participants, action }) {
        ...
        switch (action) {
            ...
            case 'remove':
                ...
                break
        case 'promote':
            text = (chat.sPromote || this.spromote || conn.spromote || 'berhasil menaikkan jabatan @user manjadi pejabat di grub ini.')
        case 'demote':
            if (!text)
                text = (chat.sDemote || this.sdemote || conn.sdemote || 'berhasil menurunkan jabatan @user menjadi rakyat biasa di grub ini.')
 ...
 @${participant.split`@`[0]} terdeteksi telah menghapus pesan
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        banned: '⛔ *AKSES DI TOLAK* ⛔\n\nYou can use it cause your number has been banned by owner',
        group: '⛔ *AKSES DI TOLAK* ⛔\n\nYou only can use this command on group',
        private: '⛔ *AKSES DI TOLAK* ⛔\n\nThis command only for private chat not for group',
        admin: '⛔ *AKSES DI TOLAK* ⛔\n\nNte admin?',
        botAdmin: '⛔ *AKSES DI TOLAK* ⛔\n\nPlease make me to be part of group amdin if you want using this command',
...
fs.watchFile(file, () => {
    fs.unwatchFile(file)
    console.log(chalk.redBright("Update 'raisa.js'"))
